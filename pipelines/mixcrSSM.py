...
def mixcrSSM(file_list, s3_output):
	...
	if (len(file_list) % 2) == 0: 
		...
		for pair1 in range(0,len(file_list),2):
			...
			mixcr = "sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr align -p rna-seq -s hsa -OallowPartialAlignments=true -r log.v3.txt /data/fastq_RNA/{} /data/fastq_RNA/{} data/output/T_Cell.v3.alignments.vdjca".format(fastq1_trimmed, fastq2_trimmed)
			mixcr_step1 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr assemblePartial data/output/T_Cell.v3.alignments.vdjca data/output/T_Cell.v3.alignments_rescued_1.vdjca'
			mixcr_step2 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr assemblePartial data/output/T_Cell.v3.alignments_rescued_1.vdjca data/output/T_Cell.v3.alignments_rescued_2.vdjca'
			mixcr_step3 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr extend data/output/T_Cell.v3.alignments_rescued_2.vdjca data/output/T_Cell.v3.alignments_rescued_2_extended.vdjca'
			mixcr_step4 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr assemble data/output/T_Cell.v3.alignments_rescued_2_extended.vdjca data/output/T_Cell.v3.clones.clns'
			mixcr_step5 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr exportClones -c TRB data/output/T_Cell.v3.clones.clns data/output/T_Cell.v3.clones.TRB.txt'
			mixcr_step6 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr exportClones -c TRA data/output/T_Cell.v3.clones.clns data/output/T_Cell.v3.clones.TRA.txt'
			mixcr_step7 = 'sudo docker run -v /home/ec2-user/:/data houghtos/immunotools:version4 /home/tools/mixcr/mixcr exportClones -c IGH data/output/T_Cell.v3.clones.clns data/output/T_Cell.v3.clones.IGH.txt'
